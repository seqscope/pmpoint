...
int32_t main(int32_t argc, char **argv)
{
  ...
  LONG_COMMAND("quadtree-test", &cmd_quadtree_test_pmtiles, "Quadtree-based spatial variability test for genes in a PMTiles file")
  ...
  LONG_COMMAND("build-point-pmtiles", &cmd_build_point_pmtiles, "Build a tiled PMTiles file based on lower zoom levels") // Added command
  END_LONG_COMMANDS();
